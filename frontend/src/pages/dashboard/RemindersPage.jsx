...
export default function RemindersPage() {
  return (
    <div>
      <PageHeader title="Reminders" subtitle="Smart alerts to keep you on track." actionLabel="New Reminder" />
            ...
            <div key={i} className="bg-white border border-gray-100 rounded-xl p-6 hover:shadow-sm transition-all">
              ...
              <div className="flex items-end justify-between">
                ...
                <div className="flex gap-2">
                  <button className="text-xs border border-gray-200 hover:bg-gray-100 px-3 py-1.5 rounded-lg text-gray-500 transition-all font-medium">Edit</button>
                  <button className="text-xs border border-gray-200 hover:bg-red-50 hover:text-red-500 hover:border-red-100 px-3 py-1.5 rounded-lg text-gray-400 transition-all font-medium">Delete</button>
                </div>
              </div>
            </div>
          );
