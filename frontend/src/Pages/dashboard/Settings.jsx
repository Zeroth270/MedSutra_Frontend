      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="lg:col-span-2 space-y-5">
          <div className="bg-white border border-gray-100 rounded-xl p-7">
            ...
            <div className="flex items-center gap-4 mb-7 pb-7 border-b border-gray-50">
              <div className="w-14 h-14 rounded-xl bg-gray-900 flex items-center justify-center font-black text-white text-xl flex-shrink-0">
                {user.avatar}
              </div>
              <div>
            ...
            <div className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm text-gray-900 focus:outline-none focus:border-gray-400 focus:ring-2 focus:ring-gray-200 transition-all"
                />
              </div>
              <div>
              ...
              <button
                onClick={handleSave}
                className={`btn-primary w-full py-3 rounded-xl text-sm ${saved ? 'bg-green-700' : ''}`}
              >
          ...
          <div className="bg-white border border-red-100 rounded-xl p-7">
            ...
            <div className="flex items-center justify-between">
              ...
              <button className="text-xs font-semibold text-red-500 border border-red-200 hover:bg-red-50 px-4 py-2 rounded-lg transition-all flex-shrink-0 ml-4">
                Delete Account
              </button>
            </div>
          </div>
        ...
        <div className="space-y-5">
          ...
          <div className="bg-gray-900 rounded-xl p-6">
            ...
            <button className="w-full bg-white text-gray-900 font-semibold py-2.5 rounded-lg text-sm hover:bg-gray-100 transition-all">
              Enable 2FA
            </button>
          </div>
        </div>
